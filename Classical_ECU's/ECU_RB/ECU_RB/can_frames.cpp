...
#define CAN_RIGHT_SEAT_BELT_HOOKED					0x3
#define CAN_RIGHT_SEAT_BELT_UNHOOKED				0x4
#define CAN_REQUEST_SEAT_BELT						0x5

can_frame frame_right_seatbelt_hoocked = {
	CAN_SEAT_BELT_ID,
	CAN_SEAT_BELT_DLC,
	{
		CAN_RIGHT_SEAT_BELT_HOOKED
	}
};

can_frame frame_right_seatbelt_unhoocked = {
	CAN_SEAT_BELT_ID,
	CAN_SEAT_BELT_DLC,
	{
		CAN_RIGHT_SEAT_BELT_UNHOOKED
	}
};
