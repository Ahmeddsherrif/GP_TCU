...
void MSDEncoder::setVehicleDirection(const float &vehicleDirection) {
...
//	i++;
	...
	encoder.appendBits(reinterpret_cast<uint32_t&>(ECallMessage.msd.msdStructure.vehicleDirection), parseSequence[i]);
	i++;
